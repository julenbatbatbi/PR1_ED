...
public interface UniversityEvents {
     ...
     */
    void addAttendee(String id, String name, String surname, LocalDate dateOfBirth);
     ...
     */
    EventRequest updateEventRequest(Status status, LocalDate date, String message) throws NoEventRequestException, NoEventRequestException;
