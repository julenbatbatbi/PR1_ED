...
public class UniversityEventsPR1Test {
    ...
    public void addAttendeeTest() {
        ...
        this.universityEvents.addAttendee("idAttendee1000", "Blai", "Gómez", createLocalDate("03-04-1955"));
        ...
        this.universityEvents.addAttendee("idAttendee9999", "XXXXX", "YYYYY", createLocalDate("13-06-1975"));
        ...
        this.universityEvents.addAttendee("idAttendee9999", "Alba", "Rema", createLocalDate("23-07-1992"));
    ...
    public void updateEventRequestTest() throws DSException {
        ...
        EventRequest request2 = this.universityEvents.updateEventRequest(Status.DISABLED, createLocalDate("12-04-2023"), "OK!!!");
        Assert.assertEquals(3, this.universityEvents.numRequests());
        Assert.assertEquals("ER-200", request2.getRequestId());
        Assert.assertEquals(1, this.universityEvents.numEvents());
        ...
        Assert.assertEquals(2, this.universityEvents.numRequests());
        Assert.assertEquals("ER-300", request3.getRequestId());
        Assert.assertEquals(2, this.universityEvents.numEvents());
        Assert.assertEquals(1, this.universityEvents.numRejectedRequests());

        EventRequest request4 = this.universityEvents.updateEventRequest(Status.ENABLED, createLocalDate("14-04-2023"), "OK!!!");
        Assert.assertEquals(1, this.universityEvents.numRequests());
        Assert.assertEquals("ER-400", request4.getRequestId());
